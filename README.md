...
```
cd existing_repo
git remote add origin https://gitlab.com/ielts-cdi-mock/dream-zone/resut-index.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ielts-cdi-mock/dream-zone/resut-bot/-/settings/integrations)
